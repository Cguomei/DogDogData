...
def test_route_structure():
    ...
    try:
        ...
        # 检查主要路由
        main_routes = ['/', '/charts', '/admin/breeds', '/map', '/chart/scatter', 
                      '/chart/line', '/chart/bar', '/chart/hist', '/chart/funnel', '/chart/map']
        auth_routes = ['/login', '/logout', '/register']
        api_routes = ['/api/breeds', '/api/food', '/api/save_pet_logs', '/custom-analysis',
                     '/api/upload-data', '/api/generate-chart', '/test-pet', '/clear-cache', '/api/restart']
...
def test_requirements():
    ...
    try:
        ...
        # 检查分类
        categories = ['核心依赖', '数据库', '数据处理', '数据可视化', '安全', '测试', '工具']
