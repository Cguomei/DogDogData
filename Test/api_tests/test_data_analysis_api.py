...
class TestDataUpload:
    ...
    def test_upload_csv_file(self, api_client, validator):
        ...
        data = {"file": (io.BytesIO(csv_data.encode("utf-8")), "test_data.csv")}
    ...
    def test_upload_excel_file(self, api_client, validator):
        ...
        data = {"file": (excel_buffer, "test_data.xlsx")}
...
3,15.5,金毛"""  # 包含空值、负数、重复行
        ...
        data = {"file": (io.BytesIO(csv_data.encode("utf-8")), "quality_test.csv")}
...
class TestDataExport:
    ...
    def test_export_empty_data(self, api_client, validator):
        """测试 15: 导出空数据（应返回错误）"""
        export_data = {"format": "csv", "filename": "test_export", "data": []}
