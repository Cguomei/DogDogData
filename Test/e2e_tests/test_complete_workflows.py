...
class TestCompleteUserJourney:
    ...
    def test_admin_breed_management_workflow(self, page: Page):
        ...
        assert breed_data['breed_name'] in page_content, \
        ...
        assert breed_data['breed_name'] not in page_content_after, \
...
class TestDataConsistency:
    ...
    def test_breed_data_consistency(self, admin_api_client, logged_in_page: Page):
        ...
        if len(api_breeds) > 0:
            ...
            assert sample_breed in page_content, \
    ...
    def test_page_load_performance(self, logged_in_page: Page):
        ...
        for path in pages:
            ...
            assert load_time_ms < 5000, \
                f"{path} 加载时间过长：{load_time_ms:.0f}ms"
