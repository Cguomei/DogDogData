...
class TestRunner:
    ...
    def run_api_tests(self):
        ...
        returncode, stdout, stderr = self.run_command(cmd, "运行API测试套件", capture_output=True)
    ...
    def run_ui_tests(self, headed=False):
        ...
        returncode, stdout, stderr = self.run_command(cmd, "运行UI测试", capture_output=True)
    ...
    def run_e2e_tests(self):
        ...
        returncode, stdout, stderr = self.run_command(cmd, "运行E2E测试", capture_output=True)
    ...
    def generate_coverage_report(self):
        ...
        returncode, stdout, stderr = self.run_command(cmd, "生成覆盖率报告", capture_output=True)
...
def main():
    ...
    parser.add_argument('--all', action='store_true', help='运行所有测试（包括UI和E2E）')
