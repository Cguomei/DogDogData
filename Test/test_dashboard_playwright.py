...
class TestDashboardHomepage:
    ...
    def test_dashboard_stats_display(self, page: Page):
        ...
        # 检查统计卡片或数据区域
        stats_elements = page.locator(".stat-card, .stats, .dashboard-stats, [class*='stat']")
...
class TestChartPages:
    ...
    def test_scatter_chart_page(self, page: Page):
        ...
        assert "散点" in page_title or "scatter" in page_title.lower(), \
    ...
    def test_line_chart_page(self, page: Page):
        ...
        page_title = page.title()
        assert "折线" in page_title or "line" in page_title.lower(), \
    ...
    def test_bar_chart_page(self, page: Page):
        ...
        page_title = page.title()
        assert "柱状" in page_title or "bar" in page_title.lower(), \
    ...
    def test_map_chart_page(self, page: Page):
        ...
        page_title = page.title()
        assert "地图" in page_title or "map" in page_title.lower(), \
...
class TestFoodDashboard:
    ...
    def test_food_dashboard_loads(self, page: Page):
        ...
        # 检查页面标题
        page_title = page.title()
        assert "狗粮" in page_title or "food" in page_title.lower(), \
