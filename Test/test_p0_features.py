...
class TestDataExport:
    ...
    def test_export_excel(self, logged_in_client):
        ...
        try:
            ...
            response = logged_in_client.post(
                "/api/export-data",
                json={"format": "excel", "filename": "test_export", "data": test_data},
            ...
            assert (
                "excel" in content_type.lower() or "spreadsheet" in content_type.lower()
            )
    ...
    def test_export_csv(self, logged_in_client):
        ...
        try:
            ...
            response = logged_in_client.post(
                "/api/export-data",
                json={"format": "csv", "filename": "test_export", "data": test_data},
                content_type="application/json",
            )
    ...
    def test_export_empty_data(self, logged_in_client):
        ...
        try:
            response = logged_in_client.post(
                "/api/export-data",
                json={"format": "excel", "filename": "test", "data": []},
                content_type="application/json",
            )
...
class TestCustomChartGeneration:
    ...
    def test_missing_chart_parameters(self, logged_in_client):
        ...
        try:
            # 缺少y_column
            chart_config = {"chart_type": "bar", "x_column": "breed", "title": "测试"}
    ...
    def test_invalid_data_filtering(self, logged_in_client):
        ...
        try:
            ...
            result.actual_result = (
                f"正确过滤无效数据，保留{json_data['data_points']}个点"
            )
