...
def get_recent_logs():
    ...
    try:
        ...
        for line in recent_lines:
            ...
            # 简单的日志解析
            log_entry = {"raw": line, "timestamp": None, "level": None, "message": None}
...
def get_recent_errors():
    ...
    try:
        ...
        while i < len(lines):
            line = lines[i].strip()
            if "ERROR" in line:
                error_entry = {"timestamp": None, "message": line, "traceback": []}
        ...
        return jsonify(
            {"success": True, "errors": recent_errors, "total_errors": len(errors)}
        )
